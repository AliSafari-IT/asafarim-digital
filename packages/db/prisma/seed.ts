...
const defaultRoles = [
  ...
  // ─── Vionto Roles ───────────────────────────────────────────
  // View-only access to shared projects and exports
  {
    name: "vionto_viewer",
    displayName: "Vionto Viewer",
    description: "Can view projects shared with them and download shared exports. Read-only access.",
    isSystem: true,
    isDefault: false,
    permissions: [
      "vionto.project.view_shared",
      "vionto.asset.view",
      "vionto.script.view",
      "vionto.export.download",
    ],
  },
  // Collaborator — can edit projects shared with them but not own them
  {
    name: "vionto_collaborator",
    displayName: "Vionto Collaborator",
    description: "Can edit projects shared with them: assets, script, subtitles, and trigger renders.",
    isSystem: true,
    isDefault: false,
    permissions: [
      "vionto.project.view_shared",
      "vionto.asset.view",
      "vionto.asset.upload",
      "vionto.asset.reorder",
      "vionto.asset.replace",
      "vionto.script.view",
      "vionto.script.edit",
      "vionto.script.regenerate",
      "vionto.voice.select",
      "vionto.voice.preview",
      "vionto.music.select",
      "vionto.music.volume",
      "vionto.subtitle.view",
      "vionto.subtitle.edit",
      "vionto.subtitle.generate",
      "vionto.render.start",
      "vionto.render.view",
      "vionto.render.cancel",
      "vionto.render.retry",
      "vionto.export.download",
      "vionto.export.share",
    ],
  },
  // Standard creator — full access to their own projects
  {
    name: "vionto_creator",
    displayName: "Vionto Creator",
    description: "Standard user who can create, edit, and manage their own Vionto projects.",
    isSystem: true,
    isDefault: false,
    permissions: [
      ...
      "vionto.project.share",
      "vionto.project.duplicate",
      "vionto.asset.upload",
      "vionto.asset.view",
      "vionto.asset.reorder",
      "vionto.asset.delete",
      ...
      "vionto.export.download",
      "vionto.export.share",
      "vionto.export.delete",
      "vionto.template.view",
      "vionto.template.use",
      "vionto.analytics.view",
      "vionto.quota.view",
    ],
  },
  // Premium creator — extended features and higher limits
  {
    name: "vionto_premium",
    displayName: "Vionto Premium",
    description: "Premium user with custom voices, priority rendering, and template creation.",
    isSystem: true,
    isDefault: false,
    permissions: [
      "vionto.project.create",
      ...
      "vionto.render.cancel",
      "vionto.render.retry",
      "vionto.render.queue_priority",
      "vionto.export.download",
      "vionto.export.share",
      "vionto.export.delete",
      "vionto.template.create",
      "vionto.template.view",
      "vionto.template.use",
      "vionto.template.delete",
      "vionto.analytics.view",
      "vionto.quota.view",
    ],
  },
  ...
  {
    name: "vionto_moderator",
    displayName: "Vionto Moderator",
    description: "Can view all projects, moderate content, and assist users but cannot manage billing.",
    isSystem: true,
    isDefault: false,
    permissions: [
      ...
      "vionto.script.view",
      "vionto.render.view",
      "vionto.export.view_all",
      "vionto.template.admin_manage",
      "vionto.admin.moderate_content",
  ...
  // Admin — full system access
  {
    ...
    description: "Full administrative access to Vionto including analytics, billing, user management, and system settings.",
    isSystem: true,
    isDefault: false,
    permissions: [
      "vionto.project.create",
      ...
      "vionto.admin.manage_users",
      "vionto.admin.moderate_content",
      "vionto.admin.system_settings",
      "vionto.admin.support",
    ],
  },
  // EduMatch roles
...
// ─── Vionto Permissions ──────────────────────────────────────
// Comprehensive permission system for the Vionto photo-to-story video app.
// Permissions are scoped to the vionto app and follow the pattern: vionto.{resource}.{action}
...
const viontoPermissions = [
  ...
  { name: "vionto.project.view_shared", displayName: "View Shared Project", group: "vionto", description: "View projects shared with the user" },
  { name: "vionto.project.edit", displayName: "Edit Project", group: "vionto", description: "Edit own Vionto project settings (title, description, mode, locale, aspect ratio, resolution, style)" },
  { name: "vionto.project.delete", displayName: "Delete Project", group: "vionto", description: "Delete own Vionto projects" },
  { name: "vionto.project.share", displayName: "Share Project", group: "vionto", description: "Share projects with other users via email and manage share permissions" },
  { name: "vionto.project.duplicate", displayName: "Duplicate Project", group: "vionto", description: "Clone an existing project as a starting point" },
  { name: "vionto.project.admin_view", displayName: "Admin View Projects", group: "vionto", description: "View all Vionto projects across all users (admin)" },

  // ─── Assets / Media ─────────────────────────────────────────
  { name: "vionto.asset.upload", displayName: "Upload Assets", group: "vionto", description: "Upload photos, videos, and other media assets" },
  { name: "vionto.asset.view", displayName: "View Assets", group: "vionto", description: "View project assets and thumbnails" },
  { name: "vionto.asset.reorder", displayName: "Reorder Assets", group: "vionto", description: "Change the order of assets in a project" },
  { name: "vionto.asset.delete", displayName: "Delete Assets", group: "vionto", description: "Remove assets from a project and storage" },
  { name: "vionto.asset.replace", displayName: "Replace Asset", group: "vionto", description: "Replace an existing asset with a new one" },

  // ─── Script / Story ─────────────────────────────────────────
  { name: "vionto.script.edit", displayName: "Edit Script", group: "vionto", description: "Edit narration script, scene descriptions, and story flow" },
  { name: "vionto.script.view", displayName: "View Script", group: "vionto", description: "View the generated or edited narration script" },
  { name: "vionto.script.regenerate", displayName: "Regenerate Script", group: "vionto", description: "Use AI to regenerate narration script from assets" },

  // ─── Voice / TTS ────────────────────────────────────────────
  { name: "vionto.voice.select", displayName: "Select Voice", group: "vionto", description: "Choose a voice preset for narration (ElevenLabs)" },
  { name: "vionto.voice.custom_upload", displayName: "Upload Custom Voice", group: "vionto", description: "Upload a custom voice sample for narration" },
  { name: "vionto.voice.preview", displayName: "Preview Voice", group: "vionto", description: "Preview voice narration before rendering" },

  // ─── Music / Soundtrack ─────────────────────────────────────
  { name: "vionto.music.select", displayName: "Select Music", group: "vionto", description: "Choose background music from the Pixabay library" },
  { name: "vionto.music.upload", displayName: "Upload Music", group: "vionto", description: "Upload custom background music track" },
  { name: "vionto.music.volume", displayName: "Adjust Music Volume", group: "vionto", description: "Set background music volume relative to narration" },

  // ─── Subtitles ──────────────────────────────────────────────
  { name: "vionto.subtitle.view", displayName: "View Subtitles", group: "vionto", description: "View subtitle configuration for a project" },
  { name: "vionto.subtitle.edit", displayName: "Edit Subtitles", group: "vionto", description: "Configure subtitle style, timing, and export options" },
  { name: "vionto.subtitle.generate", displayName: "Generate Subtitles", group: "vionto", description: "Auto-generate subtitles from narration script" },

  // ─── Rendering ──────────────────────────────────────────────
  { name: "vionto.render.start", displayName: "Start Render", group: "vionto", description: "Trigger a video render job" },
  { name: "vionto.render.view", displayName: "View Render Status", group: "vionto", description: "View render job status, progress, and logs" },
  { name: "vionto.render.cancel", displayName: "Cancel Render", group: "vionto", description: "Cancel an in-progress render job" },
  { name: "vionto.render.retry", displayName: "Retry Render", group: "vionto", description: "Retry a failed render job" },
  { name: "vionto.render.queue_priority", displayName: "Priority Rendering", group: "vionto", description: "Submit renders with higher queue priority" },

  // ─── Exports ────────────────────────────────────────────────
  { name: "vionto.export.download", displayName: "Download Export", group: "vionto", description: "Download rendered MP4 exports" },
  { name: "vionto.export.share", displayName: "Share Export", group: "vionto", description: "Generate public or private share links for rendered videos" },
  { name: "vionto.export.delete", displayName: "Delete Export", group: "vionto", description: "Delete rendered export files and records" },
  { name: "vionto.export.view_all", displayName: "View All Exports", group: "vionto", description: "View exports across all projects" },

  // ─── Templates ──────────────────────────────────────────────
  { name: "vionto.template.create", displayName: "Create Template", group: "vionto", description: "Save a project configuration as a reusable template" },
  { name: "vionto.template.view", displayName: "View Templates", group: "vionto", description: "Browse and preview available templates" },
  { name: "vionto.template.use", displayName: "Use Template", group: "vionto", description: "Create a new project from a template" },
  { name: "vionto.template.delete", displayName: "Delete Template", group: "vionto", description: "Delete own saved templates" },
  { name: "vionto.template.admin_manage", displayName: "Manage System Templates", group: "vionto", description: "Create, edit, or delete system-wide default templates" },

  // ─── Analytics & Quota ──────────────────────────────────────
  { name: "vionto.analytics.view", displayName: "View Analytics", group: "vionto", description: "View personal project and render analytics" },
  { name: "vionto.quota.view", displayName: "View Quota", group: "vionto", description: "View current usage against plan limits" },

  // ─── Admin ──────────────────────────────────────────────────
  { name: "vionto.admin.view_analytics", displayName: "View System Analytics", group: "vionto", description: "View Vionto-wide usage, render, and revenue analytics" },
  { name: "vionto.admin.manage_billing", displayName: "Manage Billing", group: "vionto", description: "Manage Vionto plans, pricing, and billing settings" },
  { name: "vionto.admin.manage_users", displayName: "Manage Users", group: "vionto", description: "View and manage Vionto user accounts and roles" },
  { name: "vionto.admin.moderate_content", displayName: "Moderate Content", group: "vionto", description: "Review and moderate user-generated projects and exports" },
  { name: "vionto.admin.system_settings", displayName: "System Settings", group: "vionto", description: "Configure Vionto system settings and feature flags" },
  ...
  const defaultApps = [
    {
      ...
      healthUrl: (process.env.NEXT_PUBLIC_PORTAL_URL ?? "https://portal.asafarim.com") + "/api/health",
      environment: "qa",
    },
    {
      ...
      url: process.env.NEXT_PUBLIC_CONTENT_GENERATOR_URL ?? "https://content-generator.asafarim.com",
      healthUrl: (process.env.NEXT_PUBLIC_CONTENT_GENERATOR_URL ?? "https://content-generator.asafarim.com") + "/api/health",
      environment: "qa",
    },
    {
      code: "ops-hub",
