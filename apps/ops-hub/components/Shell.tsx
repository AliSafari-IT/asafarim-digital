    ...
    <div ref={ref} className="relative">
      ...
      >
        {session?.user?.image ? (
          ...
          <span className="flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-cyan-500 text-[11px] font-bold text-white">
            {initials}
          </span>
        )}
            ...
            <div className="relative overflow-hidden border-b border-[var(--color-border)] p-4">
              ...
              <div className="relative flex items-center gap-3">
                {session?.user?.image ? (
                  ...
                  <span className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-cyan-500 text-lg font-bold text-white ring-2 ring-cyan-500/30">
                    {initials}
                  </span>
                )}
