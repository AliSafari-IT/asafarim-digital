...
export function QuickLink({ label, href, icon }: QuickLinkProps) {
  return (
    <a
      href={href}
      className="flex items-center gap-2.5 rounded-lg border border-[var(--color-border)] bg-[var(--color-surface-elevated)] px-4 py-3 text-sm font-medium transition-all hover:border-[var(--color-primary)] hover:shadow-sm"
    >
      <svg
