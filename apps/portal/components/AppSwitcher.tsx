  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div
          role="dialog"
          className="absolute right-0 top-[calc(100%+0.75rem)] z-50 w-[320px] rounded-3xl border border-[var(--color-border-strong)] bg-[var(--color-panel-strong)] p-3 shadow-[var(--shadow-card)]"
        >
            <div className="flex items-center justify-between px-2 pb-2">
              <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[var(--color-text-muted)]">
                ASafariM Apps
              </p>
              <span className="rounded-full bg-[var(--color-panel)] px-2 py-0.5 text-[10px] font-mono text-[var(--color-text-muted)]">
                {apps.length}
              </span>
            </div>
              ...
              {apps.map((a) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="absolute right-2 top-2 rounded-full bg-[var(--color-panel)] px-1.5 py-0.5 text-[9px] font-medium uppercase tracking-wider text-[var(--color-text-muted)]">
