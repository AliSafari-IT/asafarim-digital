...
const apps: Array<{
...
}> = [
  {
    ...
    fallback: "https://portal-qa.asafarim.com",
    mark: "A",
  ...
  },
  {
    ...
    fallback: "https://content-generator-qa.asafarim.com",
    mark: "C",
  ...
  },
  {
    ...
    fallback: "https://ops-hub.asafarim.com",
    mark: "O",
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        title="Switch app"
        className="group inline-flex h-11 w-11 items-center justify-center rounded-full border border-[var(--color-border)] bg-[var(--color-surface-elevated)] text-[var(--color-text-secondary)] transition hover:border-[var(--color-primary)] hover:text-[var(--color-text)]"
      >
      ...
      {open && (
        <div
          role="dialog"
          className="absolute right-0 top-[calc(100%+0.75rem)] z-50 w-[320px] rounded-3xl border border-[var(--color-border)] bg-[var(--color-surface)] p-3 shadow-lg"
        >
            <div className="flex items-center justify-between px-2 pb-2">
              <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[var(--color-text-secondary)]">
                ASafariM Apps
              </p>
              <span className="rounded-full bg-[var(--color-surface-elevated)] px-2 py-0.5 text-[10px] font-mono text-[var(--color-text-secondary)]">
                {apps.length}
              </span>
            </div>
              ...
              {apps.map((a) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="mt-0.5 line-clamp-1 text-[10px] text-[var(--color-text-secondary)]">
                      {a.tagline}
                    </p>
                    <span className="absolute right-2 top-2 rounded-full bg-[var(--color-surface-elevated)] px-1.5 py-0.5 text-[9px] font-medium uppercase tracking-wider text-[var(--color-text-secondary)]">
