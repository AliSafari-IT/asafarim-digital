  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div
          role="dialog"
          className="absolute right-0 top-[calc(100%+0.75rem)] z-50 w-[min(20rem,calc(100vw-1rem))] max-w-[calc(100vw-1rem)] rounded-3xl border border-[var(--color-border)] bg-[var(--color-surface)] p-3 shadow-lg"
        >
              ...
              {apps.map((a) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="mt-0.5 text-[10px] text-[var(--color-text-secondary)] sm:line-clamp-1">
                      {a.tagline}
                    </p>
